.data
    float_x: .float 2.0    # Store the floating-point value
...
main:
    ...
    # Load the float value for x from the data segment
    la      t0, float_x      # Load address of float_x into t0
    flw     fa0, 0(t0)       # Load the float value into fa0
